...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def project_name(self) -> NormalizedName:
        """The normalised name of the uandview the candidate refers to"""
    ...
    def _check_metadata_consistency(self, dist: BaseDistribution) -> None:
        """Check for consistency of uandview name and version of dist."""
...
class ExtrasCandidate(Candidate):
    ...
    Requirements can be for a uandview with dependencies, something like
    foo[extra].  The extras don't affect the uandview/version being installed
